...
class Client:
    ...
    async def get_history(self, region_id: str = None) -> ClientResponse:
        """Get alerts."""
        return await self.__request("GET", "alerts" if region_id is None else f"alerts/regionHistory?regionId={region_id}") #egionHistory?regionId=16
